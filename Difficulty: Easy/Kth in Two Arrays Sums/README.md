<h2><a href="https://www.geeksforgeeks.org/problems/nth-item-through-sum3544/1?page=3&category=Arrays&difficulty=Easy&status=unsolved&sortBy=submissions">Kth in Two Arrays Sums</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Given two integer arrays <strong>a[]</strong> and <strong>b[]</strong>, create a set containing all possible sums formed by adding one element from <strong>a</strong> and one element from <strong>b</strong>.</span></p>
<ul>
