<h2><a href="https://www.geeksforgeeks.org/problems/day-of-the-week1637/1?page=1&company=Samsung&difficulty=Easy&status=unsolved&sortBy=submissions">Day of the week</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO" style="--text-color: var(--problem-text-color);"><p><span style="font-size: 18px;">Write a program that calculates the day of the week for any particular date in the past or future.</span></p>
