...
<p><span style="font-size: 18px;"><strong>Constraints:</strong><br>1 ≤ N, K ≤ 10<sup>5<br></sup></span><span style="font-size: 18px;">1<sup>&nbsp;</sup>≤ updates[i] ≤ N, for all i from 1 to K.</span></p></div><br><p><span style=font-size:18px><strong>Topic Tags : </strong><br><code>Arrays</code>&nbsp;